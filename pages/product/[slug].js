          ...
          <div className="container px-5 py-10 mx-auto">
            <div className="lg:w-4/5 mx-auto flex flex-wrap">
              ...
              <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                ...
                <form onSubmit={serviceCheck} className="my-2">
                  <input
                    type="text"
                    name="pincode"
                    id="pincode"
                    ...
                    placeholder="Enter your service area pincode"
                  />
                  <button
                    className="rounded bg-yellow-500 hover:bg-yellow-700 p-1 px-3 mx-5 text-gray-900 font-bold"
                ...
                <div className="serviceWrap">
                  {service && (
                    <p className="text-green-700">
                      Yes, We can deliver to this service area.
                    </p>
                  )}
                  {!service && service !== null && (
                    <p className="text-red-700">
                      No, We cannot deliver to this service area.
                    </p>
                  )}
                  {service === null && (
                    <p>Check whether we can deliver to you or not!</p>
                  )}
                </div>
              </div>
            </div>
